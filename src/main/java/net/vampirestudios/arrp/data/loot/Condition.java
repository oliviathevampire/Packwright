...
import net.vampirestudios.arrp.data.predicate.DamageSourcePredicate;
import net.vampirestudios.arrp.data.predicate.EntityPredicate;
import net.vampirestudios.arrp.data.predicate.ItemPredicate;
import net.vampirestudios.arrp.data.predicate.LocationPredicate;
