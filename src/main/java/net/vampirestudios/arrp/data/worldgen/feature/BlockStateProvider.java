...
public sealed interface BlockStateProvider permits BlockStateProvider.Simple, BlockStateProvider.CopyProperties, BlockStateProvider.Weighted, BlockStateProvider.RuleBased, BlockStateProvider.RandomizedInt {
	...
	static BlockStateProvider randomizedInt(BlockStateProvider source, String property, net.vampirestudios.arrp.data.worldgen.IntProvider values) {
	...
	record RandomizedInt(BlockStateProvider source, String property, net.vampirestudios.arrp.data.worldgen.IntProvider values) implements BlockStateProvider {
		static final Codec<RandomizedInt> CODEC = RecordCodecBuilder.create(i -> i.group(
				...
				net.vampirestudios.arrp.data.worldgen.IntProvider.CODEC.fieldOf("values").forGetter(RandomizedInt::values)
