...
import net.vampirestudios.arrp.data.worldgen.feature.builders.*;
import net.vampirestudios.arrp.data.worldgen.feature.builders.geode.GeodeFeatureBuilder;
...
public final class Features {
	...
	public static TreeFeatureBuilder tree(Identifier trunkBlock, Identifier foliageBlock) {
		return new TreeFeatureBuilder()
				.trunkBlock(trunkBlock)
				.foliageBlock(foliageBlock)
				.belowTrunkProvider(BlockStateProvider.simple(VanillaIds.DIRT))
				.straightTrunk(4, 2, 0)
