...
public class WorldPreset {
	...
	public WorldPreset dimensions(Map<String, Dimension> dimensions) { this.dimensions = new LinkedHashMap<>(dimensions); return this; }
	public WorldPreset dimension(String id, Dimension dimension) { this.dimensions.put(id, dimension); return this; }
	public WorldPreset overworld(Dimension dimension) { return dimension("minecraft:overworld", dimension); }
	public WorldPreset nether(Dimension dimension) { return dimension("minecraft:the_nether", dimension); }
	public WorldPreset end(Dimension dimension) { return dimension("minecraft:the_end", dimension); }
