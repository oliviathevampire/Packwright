...
public class JDamageType {
	public static final Codec<JDamageType> CODEC = RecordCodecBuilder.create(i -> i.group(
		...
		JDamageType out = new JDamageType();
	...
	public static JDamageType damageType() {
		return new JDamageType();
	}

	public JDamageType messageId(String messageId) { this.messageId = messageId; return this; }
	public JDamageType scaling(Scaling scaling) { this.scaling = scaling; return this; }
	public JDamageType exhaustion(float exhaustion) { this.exhaustion = exhaustion; return this; }
	public JDamageType effects(Effects effects) { this.effects = effects; return this; }
	public JDamageType deathMessageType(DeathMessageType deathMessageType) { this.deathMessageType = deathMessageType; return this; }
