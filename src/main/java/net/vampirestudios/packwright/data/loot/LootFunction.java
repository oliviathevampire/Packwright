...
public class LootFunction extends PredicateBuilder<LootFunction> {
	...
	/**
	 * only applies this function when the condition passes. 26.3-snapshot-4 changed this from a
	 * {@code "conditions"} list (multiple, implicitly AND-ed) to a single optional
