...
public final class PickedUpItemConditions extends CriterionConditions {
	...
	public PickedUpItemConditions player(Condition player) { this.player = player; return this; }

	public PickedUpItemConditions player(EntityPredicate predicate) { return player(Condition.entityProperties(EntityTarget.THIS, predicate)); }
