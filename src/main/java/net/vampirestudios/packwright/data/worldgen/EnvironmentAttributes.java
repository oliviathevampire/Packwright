...
public class EnvironmentAttributes {
	...
	private final Map<Identifier, EnvironmentAttributeValue> values = new LinkedHashMap<>();
	...
	public EnvironmentAttributes set(Identifier key, DynamicMap value) {
		if (key != null && value != null) {
			this.values.put(key, EnvironmentAttributeValue.ofObject(value));
		}
		return this;
	}
	...
	public <T> EnvironmentAttributes set(Identifier key, Codec<T> codec, T value) {
		if (key != null && value != null) {
			this.values.put(key, EnvironmentAttributeValue.ofEncoded(codec, value));
		}
		return this;
	}

	public EnvironmentAttributes fogColor(String color) {
		return set(FOG_COLOR, color);
	}

	public EnvironmentAttributes fogStartDistance(float value) {
		return set(FOG_START_DISTANCE, value);
	}

	public EnvironmentAttributes fogEndDistance(float value) {
		return set(FOG_END_DISTANCE, value);
	}

	public EnvironmentAttributes skyFogEndDistance(float value) {
		return set(SKY_FOG_END_DISTANCE, value);
	}

	public EnvironmentAttributes cloudFogEndDistance(float value) {
		return set(CLOUD_FOG_END_DISTANCE, value);
	}

	public EnvironmentAttributes waterFogColor(String color) {
		return set(WATER_FOG_COLOR, color);
	}

	public EnvironmentAttributes waterFogStartDistance(float value) {
		return set(WATER_FOG_START_DISTANCE, value);
	}

	public EnvironmentAttributes waterFogEndDistance(float value) {
		return set(WATER_FOG_END_DISTANCE, value);
	}

	public EnvironmentAttributes skyColor(String color) {
		return set(SKY_COLOR, color);
	}

	public EnvironmentAttributes sunriseSunsetColor(String color) {
		return set(SUNRISE_SUNSET_COLOR, color);
	}

	public EnvironmentAttributes cloudColor(String color) {
		return set(CLOUD_COLOR, color);
	}

	public EnvironmentAttributes cloudHeight(float value) {
		return set(CLOUD_HEIGHT, value);
	}

	public EnvironmentAttributes sunAngle(float value) {
		return set(SUN_ANGLE, value);
	}

	public EnvironmentAttributes moonAngle(float value) {
		return set(MOON_ANGLE, value);
	}

	public EnvironmentAttributes starAngle(float value) {
		return set(STAR_ANGLE, value);
	}

	public EnvironmentAttributes moonPhase(String value) {
		return set(MOON_PHASE, value);
	}

	public EnvironmentAttributes starBrightness(float value) {
		return set(STAR_BRIGHTNESS, value);
	}

	public EnvironmentAttributes blockLightTint(String color) {
		return set(BLOCK_LIGHT_TINT, color);
	}

	public EnvironmentAttributes skyLightColor(int color) {
		return set(SKY_LIGHT_COLOR, color);
	}

	public EnvironmentAttributes skyLightFactor(float value) {
		return set(SKY_LIGHT_FACTOR, value);
	}

	public EnvironmentAttributes nightVisionColor(String color) {
		return set(NIGHT_VISION_COLOR, color);
	}

	public EnvironmentAttributes ambientLightColor(int color) {
		return set(AMBIENT_LIGHT_COLOR, color);
	}

	public EnvironmentAttributes musicVolume(float value) {
		return set(MUSIC_VOLUME, value);
	}

	public EnvironmentAttributes fireflyBushSounds(boolean value) {
		return set(FIREFLY_BUSH_SOUNDS, value);
	}

	public EnvironmentAttributes skyLightLevel(float value) {
		return set(SKY_LIGHT_LEVEL, value);
	}

	public EnvironmentAttributes canStartRaid(boolean value) {
		return set(CAN_START_RAID, value);
	}

	public EnvironmentAttributes waterEvaporates(boolean value) {
		return set(WATER_EVAPORATES, value);
	}

	public EnvironmentAttributes bedRule(BedRule rule) {
		return set(EnvironmentAttributes.BED_RULE, BedRule.CODEC, rule);
	}

	public EnvironmentAttributes strawBedRule(BedRule rule) {
		return set(EnvironmentAttributes.STRAW_BED_RULE, BedRule.CODEC, rule);
	}

	public EnvironmentAttributes respawnAnchorWorks(boolean value) {
		return set(RESPAWN_ANCHOR_WORKS, value);
	}

	public EnvironmentAttributes netherPortalSpawnsPiglins(boolean value) {
		return set(NETHER_PORTAL_SPAWNS_PIGLINS, value);
	}

	public EnvironmentAttributes fastLava(boolean value) {
		return set(FAST_LAVA, value);
	}

	public EnvironmentAttributes increasedFireBurnout(boolean value) {
		return set(INCREASED_FIRE_BURNOUT, value);
	}

	public EnvironmentAttributes eyeblossomOpen(String value) {
		return set(EYEBLOSSOM_OPEN, value);
	}

	public EnvironmentAttributes turtleEggHatchChance(float value) {
		return set(TURTLE_EGG_HATCH_CHANCE, value);
	}

	public EnvironmentAttributes piglinsZombify(boolean value) {
		return set(PIGLINS_ZOMBIFY, value);
	}

	public EnvironmentAttributes snowGolemMelts(boolean value) {
		return set(SNOW_GOLEM_MELTS, value);
	}

	public EnvironmentAttributes creakingActive(boolean value) {
		return set(CREAKING_ACTIVE, value);
	}

	public EnvironmentAttributes surfaceSlimeSpawnChance(float value) {
		return set(SURFACE_SLIME_SPAWN_CHANCE, value);
	}

	public EnvironmentAttributes catWakingUpGiftChance(float value) {
		return set(CAT_WAKING_UP_GIFT_CHANCE, value);
	}

	public EnvironmentAttributes beesStayInHive(boolean value) {
		return set(BEES_STAY_IN_HIVE, value);
	}

	public EnvironmentAttributes monstersBurn(boolean value) {
		return set(MONSTERS_BURN, value);
	}

	public EnvironmentAttributes canPillagerPatrolSpawn(boolean value) {
		return set(CAN_PILLAGER_PATROL_SPAWN, value);
	}

	public EnvironmentAttributes villagerActivity(String value) {
		return set(VILLAGER_ACTIVITY, value);
	}

	public EnvironmentAttributes babyVillagerActivity(String value) {
		return set(BABY_VILLAGER_ACTIVITY, value);
	}
